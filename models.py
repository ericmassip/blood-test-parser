...
class BloodTestData(BaseModel):
    ...
    HEMATIES: Optional[float] = Field(None, description="Recuento de hematíes (eritrocitos) en 10^6/µL - solo de la sección hemograma, ignorar valores de sección orina")
    ...
    NEUTROFILOS: Optional[float] = Field(None, description="Recuento absoluto de neutrófilos en 10^3/µL")
    ...
    IST: Optional[float] = Field(None, description="Índice de Saturación de Transferrina (puede llamarse IST, índice de saturación del hierro, índice de saturación de Transferrina, saturación de Transferrina, o similares) en porcentaje")
